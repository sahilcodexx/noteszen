...
export default function NewNoteCard({ onClick, layout = 'grid', label = 'New note' }: NewNoteCardProps) {
  if (layout === 'list') {
    return (
      ...
      >
        <span className="flex size-7 items-center justify-center rounded-lg border border-dashed border-border group-hover:border-primary/40 group-hover:bg-primary/5 transition-colors">
  ...
  return (
    ...
    >
      <span className="flex size-9 items-center justify-center rounded-full border border-dashed border-border group-hover:border-primary/40 group-hover:bg-primary/5 transition-colors">

...
export default function AIChatPanel({ onClose }: { onClose?: () => void }) {
  ...
  const handleSend = async () => {
    ...
    const systemParts = [
      ...
      "Default to prose paragraphs. Use bullets only when the user asks for bullets or when a checklist, steps, or a comparison genuinely reads better as a list.",
      ...
      "For explanations, prefer: a direct answer, one or two useful section headings if needed, then a short takeaway. Do not force a fixed template.",
      "For recent releases, current versions, news, prices, or facts that may have changed, do not guess. Say that you cannot verify live information in this chat unless the user provides source text, then answer from the provided source or ask for it.",
